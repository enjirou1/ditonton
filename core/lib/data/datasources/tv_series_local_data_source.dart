...
abstract class TvSeriesLocalDataSource {
  ...
  Future<void> cacheAiringToday(List<TvSeriesTable> tvSeries);
...
class TvSeriesLocalDataSourceImpl implements TvSeriesLocalDataSource {
  ...
  @override
  Future<void> cacheAiringToday(List<TvSeriesTable> tvSeriesList) async {
    await databaseHelper.clearCacheTvSeries('airing today');
    await databaseHelper.insertCacheTransactionTvSeries(tvSeriesList, 'airing today');
  }
